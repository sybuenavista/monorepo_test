...
module.exports.get = async (event, context) => {
	...
	//var a = 'eyJpdiI6IjNnMzlvZkgwQnBHUnFlM1ljOTNudGc9PSIsInZhbHVlIjoiTmJvcW5hME9QQm5YVnFyMTN3WFdvcFpoaXEvMmIzalRrcEhkRjdZeUtiaVZaa1VnSmtCOGdVTXdveGxRUzY5WWZyZE9FYTJjY1liQmpsN003VUpMWXA1ZTczOUJ6a3JqTFMvTTU';
	// var a = '';
	// console.log(a)
	// var access_token = encryptor.decrypt(a);
	...
	let integration = await mysql.query('SELECT * FROM integration_shopify WHERE store_id = '+event.store_id)
	//return if not found
